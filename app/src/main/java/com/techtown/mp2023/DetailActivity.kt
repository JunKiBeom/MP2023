...
class DetailActivity : AppCompatActivity() {
    ...
    lateinit var detail_todo_input: EditText
    lateinit var detail_todo_date: TextView
    lateinit var detail_todo_time: TextView
    lateinit var detail_confirm_btn: Button
    lateinit var detail_cancel_btn: Button
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // 뷰들 초기화
        detail_todo_input = findViewById<EditText>(R.id.detail_todo_input)
        detail_todo_date = findViewById<TextView>(R.id.detail_todo_date)
        detail_todo_time = findViewById<TextView>(R.id.detail_todo_time)
        detail_confirm_btn = findViewById<Button>(R.id.detail_confirm_btn)
        detail_cancel_btn = findViewById<Button>(R.id.detail_cancel_btn)
